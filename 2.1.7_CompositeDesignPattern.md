...
Building composed of different structures - rooms, Building
both have entry and exit but properties differ.

Design goals:
1. To compose nested structures of objects.
2. Deal with these objects of classes uniformly.

![](images/compositePattern.png)

![](images/compositePattern_2.png)
...
public class Playlist implements IComponent {
  ...
  public void play()
	{
   for(IComponent aComponent:playlist)
	 {
	 aComponent.play();
	 }
	}
	...
	public void setPlaybackSpeed(float speed)
	{
	for(IComponent aComponent: this.playlist)
	{
	  aComponent.setPlaybackSpeed(speed);
	}
	}
	...
	public void add(IComponent aComponent)
	{
		this.playlist.add(aComponent);
	}

	public void remove(IComponent aComponent)
	{
		this.playlist.remove(aComponent);
	}
}
```
```java
...
public class Song implements IComponent {
	...
	public void play()
	{
	  System.out.println("Playing song"+ this.getName());
	}
